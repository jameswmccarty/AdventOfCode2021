...
if __name__ == "__main__":
	...
	def parse_packets(packet):
		print("Parsing packet",hex(packet))
		...
		if T == 4: # found literal value
			...
			while not end_found:
				...
				bits_processed += 4
			print("value",int(L,2))
			print("processed",bits_processed)
			...
			if length_type_id == 0:
				...
				packet = packet >> 15
				bits_processed += 15
				print("Type 1 bits to process",length)
				...
				print("Type 0 number of packets",num_packets)
				packet = packet >> 11
				bits_processed += 11
	...
	print("Version sum", version_count)
